...
<head>
    ...
    <title>Edit Target Mingguan - Sistem Monitoring Program Kerja Unit KEK BP Batam</title>
            ...
            <div class="flex-1 bg-black p-8 overflow-y-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        <h1 class="text-white text-4xl font-semibold">Edit Target Mingguan</h1>
                        <div class="flex gap-3">
                            <a href="{{ route('program-kerja.show', $workProgram) }}" class="bg-neutral-800 hover:bg-neutral-700 text-gray-300 px-4 py-2.5 rounded-lg text-sm">
                                👁️ Lihat Program
                            </a>
                    ...
                    <div class="bg-neutral-800 rounded-lg p-4 mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-white font-semibold">{{ $workProgram->name }}</h2>
                                <p class="text-gray-400 text-sm">Mengedit target mingguan: {{ Str::limit($weeklyTarget->uraian, 50) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-neutral-900 rounded-2xl p-8">
                    <form method="POST" action="{{ route('program-kerja.weekly-targets.update', [$workProgram, $weeklyTarget]) }}" class="space-y-6">
                        @csrf
                        @method('PATCH')

                        <h3 class="text-white text-lg font-semibold mb-6">Detail Target Mingguan</h3>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                >{{ old('uraian', $weeklyTarget->uraian) }}</textarea>
                                @error('uraian')
                            ...
                            <div>
                                ...
                                >{{ old('realisasi_minggu_ini', $weeklyTarget->realisasi_minggu_ini) }}</textarea>
                            ...
                            <div>
                                ...
                                >{{ old('keterangan', $weeklyTarget->keterangan) }}</textarea>
                                @error('keterangan')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                >{{ old('target_minggu_berikut', $weeklyTarget->target_minggu_berikut) }}</textarea>
                        ...
                        <div class="flex gap-4 pt-8 border-t border-neutral-700">
                            ...
                            <a href="{{ route('program-kerja.show', $workProgram) }}" class="bg-neutral-800 hover:bg-neutral-700 text-gray-300 font-medium py-3 px-6 rounded-lg text-sm transition">
                                Batal
                            </a>
                        </div>
                    </form>
