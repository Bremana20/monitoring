...
<head>
    ...
    <title>Tambah Target Mingguan - Sistem Monitoring Program Kerja Unit KEK BP Batam</title>
            ...
            <div class="flex-1 bg-black p-8 overflow-y-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        <h1 class="text-white text-4xl font-semibold">Tambah Target Mingguan</h1>
                    ...
                    <div class="bg-neutral-800 rounded-lg p-4 mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">Menambahkan target mingguan baru</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-neutral-900 rounded-2xl p-8">
                    <form method="POST" action="{{ route('program-kerja.weekly-targets.store', $workProgram) }}" class="space-y-6">
                        @csrf
