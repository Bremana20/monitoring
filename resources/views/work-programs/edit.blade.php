...
<head>
    ...
    <title>Edit Program Kerja - Sistem Monitoring Program Kerja Unit KEK BP Batam</title>
            ...
            <div class="flex-1 bg-black p-8 overflow-y-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        <h1 class="text-white text-4xl font-semibold">Edit Program Kerja KEK</h1>
                ...
                <div class="bg-neutral-900 rounded-2xl p-8">
                    <form method="POST" action="{{ route('program-kerja.update', $workProgram) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $workProgram->name) }}"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                >{{ old('uraian', $workProgram->weeklyTargets->first()?->uraian) }}</textarea>
                                @error('uraian')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                >{{ old('realisasi_minggu_ini', $workProgram->weeklyTargets->first()?->realisasi_minggu_ini) }}</textarea>
                            ...
                            <div>
                                ...
                                >{{ old('keterangan', $workProgram->weeklyTargets->first()?->keterangan) }}</textarea>
                                @error('keterangan')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                >{{ old('target_minggu_berikut', $workProgram->weeklyTargets->first()?->target_minggu_berikut) }}</textarea>
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                        class="w-full bg-neutral-800 text-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border border-neutral-700">
                                    <option value="belum_selesai" {{ old('status', $workProgram->status) === 'belum_selesai' ? 'selected' : '' }}>Belum Selesai</option>
                                    <option value="sedang_proses" {{ old('status', $workProgram->status) === 'sedang_proses' ? 'selected' : '' }}>Sedang Proses</option>
